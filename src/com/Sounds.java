...
final class Sounds {
	...
	private int method243() {
		int i = 0x98967f;
		for (int j = 0; j < 10; j++)
			if (aClass6Array329[j] != null
					&& aClass6Array329[j].anInt114 / 20 < i)
	...
	private int method245(int i) {
		...
		for (int i2 = 0; i2 < 10; i2++) {
			...
			int ai[] = aClass6Array329[i2].method167(k2,
		...
		if (i > 1) {
			...
			for (int i3 = 1; i3 < i; i3++) {
				int k3 = (j1 - i1) * i3;
				System.arraycopy(aByteArray327, i1, aByteArray327, i1 + k3, j1
						- i1);
			}
