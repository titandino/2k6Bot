...
public final class Model extends Animable {
	...
	public Model(boolean flag, boolean flag1, boolean flag2, Model model) {
		...
		if (flag) {
			...
			anIntArray1640 = new int[anInt1630];
			System.arraycopy(model.anIntArray1640, 0, anIntArray1640, 0,
					anInt1630);
		...
		if (flag1) {
			...
			if (model.anIntArray1639 == null) {
				...
				System.arraycopy(model.anIntArray1639, 0, anIntArray1639, 0,
						anInt1630);
	...
	public Model(boolean flag, boolean flag1, Model model) {
		...
		if (flag) {
			anIntArray1628 = new int[anInt1626];
			System.arraycopy(model.anIntArray1628, 0, anIntArray1628, 0,
					anInt1626);
		...
		if (flag1) {
			...
			if (model.anIntArray1637 == null) {
				...
				System.arraycopy(model.anIntArray1637, 0, anIntArray1637, 0,
						anInt1630);
	...
	private void method468() {
		...
		anInt1652 = anInt1653
				+ (int) Math
						.sqrt(anInt1650 * anInt1650 + anInt1651 * anInt1651);
	}
