...
final class Animable_Sub4 extends Animable {
	...
	public void method455(int i, int j, int k, int l) {
		...
		aDouble1576 = Math.sqrt(aDouble1574 * aDouble1574 + aDouble1575
				* aDouble1575);
		if (!aBoolean1579)
			aDouble1577 = -aDouble1576
					* Math.tan((double) anInt1588 * 0.02454369D);
		aDouble1578 = (2D * ((double) k - aDouble1587 - aDouble1577 * d1))
				/ (d1 * d1);
	}
	...
	public void method456(int i) {
		...
		aDouble1587 += aDouble1577 * (double) i + 0.5D * aDouble1578
				* (double) i * (double) i;
